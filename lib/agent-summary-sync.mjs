...
export function mergeAgentSummaryRows(dashboard, rows, now = new Date().toISOString()) {
  ...
  const current = analysis.runId === expectedRunId && ['success', 'partial'].includes(analysis.analysisStatus);
  if (!current) return { dashboard, analysis, expectedRunId, current: false };
