...
function compactWorkItem(item) {
  return pick(item, [
    ...
    'sprint', 'specId', 'spec', 'notionUpdatedAt', 'latestGitAt', 'overdueDays',
    'staleBusinessDays', 'riskScore', 'guideStatus',
  ]);
}
...
function compactProject(project) {
  return {
    ...
    specs: (project.specs || []).map(spec => ({
      ...pick(spec, ['id', 'title', 'status', 'sprint', 'core', 'owners', 'targetAt']),
      tasks: [],
    })),
  };
}
